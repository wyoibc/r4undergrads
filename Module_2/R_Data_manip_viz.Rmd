...
Before we can work with the data, we need to download it. Go to the Github repository for this workshop: [https://github.com/wyoibc/r4undergrads](https://github.com/wyoibc/r4undergrads) and click on the green `Code` button, then on the `Download ZIP` button. (You can alternately clone the repo if you're familiar with git). You can also download the individual files from [here](https://github.com/wyoibc/r4undergrads/tree/master/lizard_data) if you know how to do that.
...
```{r, eval = FALSE}
setwd("~/r4undergrads-master/lizard_data/")
```
